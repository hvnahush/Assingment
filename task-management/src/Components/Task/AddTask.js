...
const AddTask = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const docRef = await addDoc(collection(db, "tasks"), serializableFormData);
        ...
        <div className="w-[70%] mx-auto">
            ...
            <div className='grid place-items-center'>
                <form className="w-full mt-12 sm:mt-0 max-w-lg" onSubmit={handleSubmit}>
                    ...
                    <button type='submit' className='mt-8 w-full p-3 bg-indigo-500 rounded-lg text-center text-white hover:bg-indigo-300'>
                        Add
                    </button>
                </form>
            </div>
