...
const TaskCard = ({
    ...
    return (
        ...
        >
            ...
            {/* Content Section */}
            <div className="border-0 p-2 text-center overflow-y-auto max-h-[170px]">
                {/* Scrollable description and date section */}
            ...
            <div className="footer p-3 flex items-center justify-between">
                <button
                    ...
                    type="button"
                    className={`flex items-center justify-center gap-2 text-black select-none focus:outline-none shadow-md uppercase font-bold text-xs py-2 px-6 rounded-lg ${complete ? 'bg-green-200 text-green-800' : `${getStatusColor(status)}`}`}
                >
